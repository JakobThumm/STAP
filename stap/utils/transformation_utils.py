"""These functions are taken from pytorch3d, so that we don't have to depend on it."""
...
def random_rotations(
    ...
    Args:
        ...
        dtype: Type to return.
        device: torch.device of returned tensor. Default: if None,
            uses the current device for the default tensor type.
...
def random_rotation(dtype: Optional[torch.dtype] = None, device: Optional[torch.device] = None) -> torch.Tensor:
    """
