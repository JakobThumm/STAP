...
def calc_capsule_pose(p1: np.ndarray, p2: np.ndarray):
...
class Human(body.Body):
    ...
    def animate(self, time: float) -> None:
        ...
        self._set_poses(self._animation[animation_idx])

    def _set_poses(self, measurements: np.ndarray) -> None:
